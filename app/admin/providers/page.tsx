            ...
            <div className="space-y-6">
              <div className="overflow-hidden rounded-[2rem] bg-white shadow-xl shadow-blue-50">
                <div className="border-b border-slate-100 p-6">
                  ...
                  <p className="mt-1 text-slate-600">
                    Each provider controls how DALO orders the eSIM after
                    payment.
                  </p>
                </div>
              ...
              <div className="overflow-hidden rounded-[2rem] bg-white shadow-xl shadow-blue-50">
                <div className="border-b border-slate-100 p-6">
                  ...
                  <p className="mt-1 text-slate-600">
                    These DALO products are connected to provider product IDs.
                  </p>
                </div>
            ...
            <div className="space-y-6">
              <div className="rounded-[2rem] bg-slate-950 p-8 text-white shadow-xl">
                ...
                <p className="mt-2 text-slate-300">
                  Later, your API credentials will be stored securely as
