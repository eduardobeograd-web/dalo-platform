  ...
  return (
    <main className="dalo-page dalo-content-page min-h-screen bg-[#F6F8FF] text-slate-900">
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="dalo-content-hero rounded-[2rem] bg-white p-8 shadow-xl shadow-blue-100">
        ...
        <section className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {destinations.map((destination) => (
            <Link
              ...
              className="rounded-[1.5rem] border border-white/90 bg-white/90 p-6 shadow-[0_16px_38px_rgba(30,64,120,0.1)] transition hover:-translate-y-1 hover:shadow-[0_22px_48px_rgba(30,64,120,0.14)]"
            >
